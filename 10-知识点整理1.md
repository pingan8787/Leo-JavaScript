...
## 目录  
* [1、数据类型 / 转换](#title1)
* [2、函数表达式 和 函数声明](#title2)
* [3、var let const](#title3)
* [4、上下文](#title4)
* [5、函数调用方式：call apply bind](#title5)
* [6、严格模式](#title6)
* [7、Object.keys()](#title7)
* [8、"void"运算符](#title8)
* [9、简单介绍闭包](#title9)
* [10、JS书写规范](#title10)

### <span id="title1">1、数据类型 / 转换</span>
...
### <span id="title2">2、函数表达式 和 函数声明</span>
...
### <span id="title3">3、var let const</span>
...
### <span id="title5">5、函数调用方式：call apply bind</span>
...
### <span id="title7">7、Object.keys()</span>
...
### <span id="title8">8、"void"运算符</span>
...
### <span id="title10">10、JS书写规范</span>
